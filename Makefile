...
# By CasTolax 2026
# Print OS OK
# but we need VGA drivers...
RED=\033[31m
GREEN=\033[32m
RESET_COLOR=\033[0m

print:
	@echo "$(RED)EpsilonOS TEST$(RESET)"
	@echo "$(GREEN)EpsilonOS TEST$(RESET)"
...
fs.img: mkfs/mkfs README.md TUTO.md LICENSE.md logo.txt  $(UPROGS)
	mkfs/mkfs fs.img README.md TUTO.md LICENSE.md logo.txt $(UPROGS)
